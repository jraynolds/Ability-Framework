...
## An EffectResource that adds a given IOLayer to an Entity.
class_name AddIOLayerEffectResource
...
@export var iolayer_added : IOLayerResource ## The IOLayer this Effect adds to an Entity.
...
func affect(effect: Effect, ability: Ability, caster: Entity, targets: Array[Entity]):
	...
	for target in targets_found:
		target.statuses_component.add_iolayer_from_resource(iolayer_added, ability, caster, stacking_behavior, lifetimes, expiration_behavior)
